...
enum AppSettings {
    ...
    nonisolated static let defaultSettingsWindowSize = CGSize(width: 1200, height: 680)
    nonisolated static let minimumSettingsWindowSize = CGSize(width: 900, height: 560)
